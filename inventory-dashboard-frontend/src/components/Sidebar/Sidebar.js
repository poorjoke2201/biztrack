...
// Import useAuth to conditionally render admin links
import { useAuth } from '../../hooks/useAuth'; // Adjust path if needed
// TODO: Import real icons if desired
           ...
           {isAdmin && (
                <li>
                    <NavLink to="/stock-prediction" className={getLinkClassName('/stock-prediction')} onClick={() => onLinkClick('/stock-prediction')}>
                        <span className={styles.iconPlaceholder}>📈</span> {/* Using analytics icon for now */}
          ...
          {/* === Manage Invoice Section === */}
           ...
           {isAdmin && (
            ...
            <li className={styles.logoutSection}>
              {/* TODO: Fix logout onClick to use context logout */}
